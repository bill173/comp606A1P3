...
<script>
  function bur(){
   ...
   var m = document.getElementById("motivation");
        location.href="booking.php?"+"date="+s.value+"&name="+n.value+"&email="+e.value+"&type="+t.value+"&motivation="+m.value;
...
<div class="bd">
    <div class="fd">
        ...
        <form action="booking_act.php" id="registration" name="registration" class="content" method="post">
        ...
        <select name="time" id="timeslot" style="width:180px;height:30px">
            ...
            <option value="10:00:00" <?php foreach($arr as $v){if(in_array("10:00:00",$v)){echo "disabled";} }?> >10:00</option>
            <option value="11:00:00" <?php foreach($arr as $v){if(in_array("11:00:00",$v)){echo "disabled";} }?> >11:00</option>
            <option value="13:00:00" <?php foreach($arr as $v){if(in_array("13:00:00",$v)){echo "disabled";} }?>>13:00</option>
            <option value="14:00:00" <?php foreach($arr as $v){if(in_array("14:00:00",$v)){echo "disabled";} }?>>14:00</option>
            <option value="15:00:00" <?php foreach($arr as $v){if(in_array("15:00:00",$v)){echo "disabled";} }?> >15:00</option>
        </select>
